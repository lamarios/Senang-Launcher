          ...
          child: BlocProvider(
              ...
              child: BlocBuilder<SettingsCubit, SettingsState>(
                builder: (context, settings) {
                  ...
                  final isLetterFilter = context.select(
                      (AppListCubit value) => value.state.isLetterFilter);
                  final loading = context
                      .select((AppListCubit value) => value.state.loading);
                  final filter = context
                      .select((AppListCubit value) => value.state.filter);
